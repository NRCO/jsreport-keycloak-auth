...
module.exports = function (reporter, definition) {
  ...
  reporter.on('after-express-static-configure', (app) => {
    ...
    app.use(session({ secret: 'zàeçwxkcoxwàçwàdçw' }))
    ...
    // évite les risque d'exposition des configurations du module
    // en préservant les configuration dédiées au front
    definition.options = {
      'client-config': definition.options['client-config']
    }
